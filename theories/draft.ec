...
type 'a CommutativeSemiGroup = 'a SemiGroup.
...
type 'a CommutativeMonoid = 'a Monoid.
op intCommutativeMonoid: int CommutativeMonoid = {|id = Int.zero; s=intCommutativeSemiGroup|}.

(* The following proof seeks to illustrate how type classes may be used in proofs *)
