...
declare module A : Adversary {G1, G2, G, Sx, Count, OAEU, OBEU, OAG, OBG}.
...
(* add lemma to avoid duplication *)
...
- proc; inline *; sp.
  ...
  rnd (exp g) (elog); auto => /> *.
  split; 1: smt(expK supp_dmap supp_duniform).
  move => ?; split; 2: smt(expK supp_dmap supp_duniform).
